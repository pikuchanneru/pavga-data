...
if __name__ == "__main__":
    ...
    # path_q1 = os.path.join(os.getcwd(), "query", "create-table-freshdesk.sql")
    # path_q2 = os.path.join(os.getcwd(), "query", "create-trigger-update_at_db-freshdesk.sql")
    # path_q3 = os.path.join(os.getcwd(), "query", "add-trigger-ticket.sql")
    # path_q4 = os.path.join(os.getcwd(), "query", "insert-genshin.sql")
    ...
    path_q = os.path.join(os.getcwd(), "query-initiate", "create_trigger_set_timestamp.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_table_trainer.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_trigger_trainer.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_table_tournament.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_trigger_tournament.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_table_standing.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)

    path_q = os.path.join(os.getcwd(), "query-initiate", "create_trigger_standing.sql")
    with open(path_q, "r") as file:
        query = file.read()
    execute(query, connection, cursor)
